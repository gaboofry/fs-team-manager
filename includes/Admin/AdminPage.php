...
class AdminPage {
    ...
    public static function addMenu() {
        ...
        add_menu_page('Fabriel Team Manager', 'Fabriel Software', $cap, 'fs-tm-manager', array(__CLASS__, 'renderHubPage'), $icon_data, 30);
        ...
        add_submenu_page(
            'fs-tm-manager',
            'Fabriel Software &bull; ' . __('Einstellungen', 'fabriel-team-manager'),
            '⚙️ ' . __('Einstellungen', 'fabriel-team-manager'),
            $cap,
            SettingsPage::SLUG,
    ...
    public static function enqueueAssets($hook) {
        ...
        wp_set_script_translations('fs-tm-admin-js', 'fabriel-team-manager', FS_TM_PATH . 'languages');
    ...
    public static function ajaxSaveOrder() {
        ...
        if (!Plugin::currentUserCan()) {
            wp_send_json_error(array('message' => __('Keine Berechtigung.', 'fabriel-team-manager')));
        }
    ...
    public static function ajaxGetTeamForm() {
        ...
        if (empty($slug) || !$team) {
            wp_send_json_error(array('message' => __('Mannschaft nicht gefunden.', 'fabriel-team-manager')));
        }
            ...
            <div class="postbox fs-tm-box fs-tm-collapsible-box is-collapsed" id="fs-tm-add-box">
                <div class="fs-tm-collapsible-header" title="<?php esc_attr_e('Klicken zum Auf-/Zuklappen', 'fabriel-team-manager'); ?>">
                    <div class="fs-tm-collapsible-title">
                        ...
                        <h2>➕ <?php esc_html_e('Neue Mannschaft anlegen', 'fabriel-team-manager'); ?></h2>
                    </div>
                        ...
                        <div class="fs-tm-add-grid">
                            <div class="fs-tm-field-group">
                                <label for="new_team_name">
                                    <?php esc_html_e('Mannschaftsname', 'fabriel-team-manager'); ?>
                                    <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Vollständiger Name des Teams, z. B. 1. Mannschaft oder B-Jugend.', 'fabriel-team-manager'); ?>">?</span>
                                </label>
                                <input type="text" id="new_team_name" name="new_team_name" placeholder="<?php esc_attr_e('z. B. 1. Mannschaft', 'fabriel-team-manager'); ?>" class="fs-tm-input" required>
                            </div>
                            <div class="fs-tm-field-group">
                                <label for="new_team_slug">
                                    <?php esc_html_e('Kürzel (Slug)', 'fabriel-team-manager'); ?>
                                    <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Eindeutige technische Kennung (z. B. 1-mannschaft). Bleibt es leer, wird es automatisch erzeugt.', 'fabriel-team-manager'); ?>">?</span>
                                </label>
                                <input type="text" id="new_team_slug" name="new_team_slug" placeholder="<?php esc_attr_e('z. B. 1-mannschaft', 'fabriel-team-manager'); ?>" class="fs-tm-input">
                            </div>
                            <div class="fs-tm-field-group">
                                <label for="new_team_page">
                                    <?php esc_html_e('Zugeordnete Seite', 'fabriel-team-manager'); ?>
                                    <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Auf dieser Unterseite erkennt der Gutenberg-Block das Team automatisch. Stellen Sie dazu im Block Backend „Automatisch (anhand Seite)“ ein.', 'fabriel-team-manager'); ?>">?</span>
                                </label>
...
?>
                            ...
                            <div class="fs-tm-btn-wrap">
                                <input type="submit" name="fs_tm_add_team_submit" class="button fs-tm-btn-primary" value="+ <?php esc_attr_e('Mannschaft anlegen', 'fabriel-team-manager'); ?>">
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="fs-tm-toolbar">
                <div class="fs-tm-search-wrap">
                    ...
                    <input type="text" id="fs-tm-search" placeholder="<?php esc_attr_e('Mannschaften durchsuchen...', 'fabriel-team-manager'); ?>" class="fs-tm-input">
                </div>
            ...
            <div id="fs-tm-team-sortable" class="fs-tm-team-accordion-list">
                <?php if (empty($teams)): ?>
                    <div class="fs-tm-empty-notice postbox fs-tm-box">
                        <p><?php esc_html_e('Noch keine Mannschaften angelegt. Nutze das Formular oben, um das erste Team anzulegen!', 'fabriel-team-manager'); ?></p>
                    </div>
                <?php else: ?>
                    ...
                    ?>
                        <div class="fs-tm-team-card fs-tm-collapsible-box <?php echo $is_team_open ? 'is-expanded' : 'is-collapsed'; ?>" data-slug="<?php echo esc_attr($slug); ?>">
                            <div class="fs-tm-team-header" title="<?php esc_attr_e('Klicken zum Öffnen/Schließen', 'fabriel-team-manager'); ?>">
                                <div class="fs-tm-team-header-left">
                                    <span class="dashicons dashicons-menu fs-tm-drag-handle" title="<?php esc_attr_e('Ziehen zum Sortieren', 'fabriel-team-manager'); ?>"></span>
                                    <span class="dashicons dashicons-arrow-down-alt2 fs-tm-accordion-arrow"></span>
                                ...
                                <div class="fs-tm-team-header-right">
                                    <a href="<?php echo esc_url($delete_url); ?>" class="button button-small button-link-delete fs-tm-btn-del" title="<?php esc_attr_e('Mannschaft löschen', 'fabriel-team-manager'); ?>" data-fs-tm-confirm="<?php echo esc_attr(sprintf(/* translators: %s: team name */ __('Mannschaft „%s" wirklich löschen?', 'fabriel-team-manager'), $team['name'])); ?>">🗑️</a>
                                </div>
                            </div>
                ...
                <div class="fs-tm-modal-dialog">
                    <div class="fs-tm-modal-header">
                        <div class="fs-tm-modal-title">
                            ...
                            <h3><?php esc_html_e('Widget-Inspector', 'fabriel-team-manager'); ?></h3>
                        </div>
                        <div class="fs-tm-modal-devices">
                            <button type="button" class="button fs-tm-device-btn is-active" data-device="desktop" title="<?php esc_attr_e('Desktop (100%)', 'fabriel-team-manager'); ?>">💻 <span>Desktop</span></button>
                            <button type="button" class="button fs-tm-device-btn" data-device="tablet" title="<?php esc_attr_e('Tablet (640px)', 'fabriel-team-manager'); ?>">📱 <span>Tablet</span></button>
                            <button type="button" class="button fs-tm-device-btn" data-device="mobile" title="<?php esc_attr_e('Smartphone (360px)', 'fabriel-team-manager'); ?>">📲 <span>Mobile</span></button>
                        </div>
                        <button type="button" class="fs-tm-modal-close" title="<?php esc_attr_e('Schließen', 'fabriel-team-manager'); ?>">&times;</button>
                    </div>
                    <div class="fs-tm-modal-meta">
                        <div><strong><?php esc_html_e('Typ:', 'fabriel-team-manager'); ?></strong> <code id="fs-tm-preview-type-badge">-</code></div>
                        <div><strong><?php esc_html_e('UUID:', 'fabriel-team-manager'); ?></strong> <code id="fs-tm-preview-uuid-badge">-</code></div>
                    </div>
        ...
        <form method="post" action="" class="fs-tm-team-form">
            ...
            <?php if (!empty($errors)): ?>
                <div class="notice notice-error fs-tm-form-errors">
                    <p><strong><?php esc_html_e('Die letzte Speicherung wurde abgebrochen:', 'fabriel-team-manager'); ?></strong></p>
                    <ul>
            ...
            <div class="postbox fs-tm-box fs-tm-section-box is-expanded" data-fs-tm-section="core-basics">
                <div class="fs-tm-section-header" title="<?php esc_attr_e('Klicken zum Auf-/Zuklappen', 'fabriel-team-manager'); ?>">
                    <div class="fs-tm-section-header-left">
                        <span class="dashicons dashicons-arrow-down-alt2 fs-tm-accordion-arrow"></span>
                        <h2>⚽ <?php esc_html_e('Stammdaten & Zuordnung', 'fabriel-team-manager'); ?></h2>
                    </div>
                </div>
                <div class="fs-tm-section-body">
                    <div class="fs-tm-form-grid">
                        <div class="fs-tm-field-group">
                            <label>
                                <?php esc_html_e('Mannschaftsname:', 'fabriel-team-manager'); ?>
                                <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Offizieller Name der Mannschaft auf der Vereinswebsite.', 'fabriel-team-manager'); ?>">?</span>
                            </label>
                        ...
                        <div class="fs-tm-field-group">
                            <label>
                                <?php esc_html_e('Zugeordnete WordPress-Seite:', 'fabriel-team-manager'); ?>
                                <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Auf dieser Unterseite erkennt der Gutenberg-Block das Team automatisch. Stellen Sie dazu im Block Backend „Automatisch (anhand Seite)“ ein.', 'fabriel-team-manager'); ?>">?</span>
                            </label>
...
?>
            ...
            <div class="postbox fs-tm-box fs-tm-section-box is-collapsed" data-fs-tm-section="core-periods">
                <div class="fs-tm-section-header" title="<?php esc_attr_e('Klicken zum Auf-/Zuklappen', 'fabriel-team-manager'); ?>">
                    <div class="fs-tm-section-header-left">
                        <span class="dashicons dashicons-arrow-down-alt2 fs-tm-accordion-arrow"></span>
                        <h2>
                            📅 <?php esc_html_e('Spielpläne & Tabellen', 'fabriel-team-manager'); ?>
                            <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Klicke auf einen Zeitraum-Balken, um Details auf- oder zuzuklappen. Vergangene Zeiträume sind standardmäßig eingeklappt.', 'fabriel-team-manager'); ?>">?</span>
                        </h2>
                    </div>
                    <button type="button" class="button fs-tm-btn-add-period" title="<?php esc_attr_e('Neuen Zeitraum hinzufügen', 'fabriel-team-manager'); ?>">
                        <span class="dashicons dashicons-plus-alt2"></span>
                        <span class="fs-tm-btn-add-period-text"><?php esc_html_e('Neuen Zeitraum hinzufügen', 'fabriel-team-manager'); ?></span>
                    </button>
                </div>
                <div class="fs-tm-section-body">
                    <div class="fs-tm-periods-container">
                        <?php if (empty($periods)): ?>
                            <div class="fs-tm-no-periods-msg">
                                ...
                                <p><?php echo wp_kses_post(__('Noch kein Zeitraum hinterlegt. Klicke auf <strong>„+ Neuen Zeitraum hinzufügen“</strong>, um Spielplan- und Tabellen-IDs einzutragen.', 'fabriel-team-manager')); ?></p>
                            </div>
                        <?php else: ?>
                            <?php foreach ($periods as $p_idx => $p): 
                                ...
                                $p_label_display = !empty($p['label']) ? $p['label'] : sprintf(__('Zeitraum %d', 'fabriel-team-manager'), $p_idx + 1);
                            ...
                            ?>
                                <div class="<?php echo esc_attr(implode(' ', $card_classes)); ?>">
                                    <div class="fs-tm-period-card-header" title="<?php esc_attr_e('Klicken zum Auf-/Zuklappen', 'fabriel-team-manager'); ?>">
                                        <div class="fs-tm-period-card-header-left">
                                            ...
                                            <?php if ($is_act): ?>
                                                <span class="fs-tm-active-badge">🟢 <?php esc_html_e('Aktiver Zeitraum', 'fabriel-team-manager'); ?></span>
                                            <?php elseif ($is_past): ?>
                                                <span class="fs-tm-past-badge">⚪ <?php esc_html_e('Vergangen', 'fabriel-team-manager'); ?></span>
                                            <?php elseif ($is_future): ?>
                                                <span class="fs-tm-future-badge">🔵 <?php esc_html_e('Zukünftig', 'fabriel-team-manager'); ?></span>
                                            <?php endif; ?>
                                            <button type="button" class="button-link-delete fs-tm-delete-period" title="<?php esc_attr_e('Zeitraum löschen', 'fabriel-team-manager'); ?>">
                                    ...
                                    <div class="fs-tm-period-card-body">
                                        <div class="fs-tm-field-group fs-tm-label-row">
                                            <label>
                                                <?php esc_html_e('Bezeichnung des Zeitraums:', 'fabriel-team-manager'); ?>
                                                <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Wird im Frontend-Dropdown und im Header angezeigt (z. B. Saison 2026/2027 oder Hinrunde).', 'fabriel-team-manager'); ?>">?</span>
                                            </label>
                                            <input type="text" name="team[periods][<?php echo esc_attr($p_idx); ?>][label]" value="<?php echo esc_attr($p['label'] ?? ''); ?>" placeholder="<?php esc_attr_e('z. B. Saison 2026/2027 oder Hinrunde', 'fabriel-team-manager'); ?>" class="fs-tm-input period-label-input" required>
                                        </div>

                                        <div class="fs-tm-period-dates-row">
                                            <div class="fs-tm-field-group">
                                                <label>
                                                    <?php esc_html_e('Gültig ab (Start):', 'fabriel-team-manager'); ?>
                                                    <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Datum, ab dem die Website automatisch auf diesen Zeitraum umschaltet.', 'fabriel-team-manager'); ?>">?</span>
                                                </label>
                                            ...
                                            <div class="fs-tm-field-group">
                                                <label>
                                                    <?php esc_html_e('Gültig bis (optional):', 'fabriel-team-manager'); ?>
                                                    <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Enddatum. Muss nahtlos an den nächsten Zeitraum anschließen.', 'fabriel-team-manager'); ?>">?</span>
                                                </label>
                                                <div class="fs-tm-date-input-wrap">
                                        ...
                                        <div class="fs-tm-period-ids-row">
                                            ...
                                            <div class="fs-tm-field-group">
                                                <label class="fs-tm-matches-label">
                                                    📅 <span class="fs-tm-matches-label-text"><?php echo $p_is_club ? esc_html__('Spielplan-ID des Vereins:', 'fabriel-team-manager') : esc_html__('Spielplan-ID der Mannschaft:', 'fabriel-team-manager'); ?></span>
                                                    <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('UUID aus dem Einbettungscode von fussball.de (data-type „team-matches“).', 'fabriel-team-manager'); ?>">?</span>
                                                </label>
                                                <div class="fs-tm-uuid-input-wrap">
                                                    ...
                                                    <button type="button" class="button fs-tm-btn-test-uuid" data-target="matches" title="<?php esc_attr_e('Widget live testen / Vorschau', 'fabriel-team-manager'); ?>">
                                            ...
                                            <div class="fs-tm-field-group">
                                                <label>
                                                    🏆 <?php esc_html_e('Tabellen-ID:', 'fabriel-team-manager'); ?>
                                                    <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('UUID aus dem Einbettungscode von fussball.de (data-type „table“).', 'fabriel-team-manager'); ?>">?</span>
                                                </label>
                                                <div class="fs-tm-uuid-input-wrap">
                                                    ...
                                                    <button type="button" class="button fs-tm-btn-test-uuid" data-target="table" title="<?php esc_attr_e('Widget live testen / Vorschau', 'fabriel-team-manager'); ?>">
                                                        <span class="dashicons dashicons-visibility"></span>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="fs-tm-period-footer-row">
                                            <label class="fs-tm-checkbox-pill">
                                                ...
                                                <span><?php esc_html_e('Club-Matches', 'fabriel-team-manager'); ?></span>
                                                <span class="fs-tm-help-tip" data-tip="<?php esc_attr_e('Schaltet den Widget-Typ von „team-matches“ auf „club-matches“ um.', 'fabriel-team-manager'); ?>">?</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="fs-tm-team-actions-bar">
                <input type="submit" name="fs_tm_save_team_single" class="button fs-tm-btn-save-main" value="💾 <?php esc_attr_e('Änderungen speichern', 'fabriel-team-manager'); ?>">
                <button type="button" class="button fs-tm-btn-reset-team"><?php esc_html_e('🔄 Änderungen verwerfen', 'fabriel-team-manager'); ?></button>
                <button type="button" class="button fs-tm-btn-close-team"><?php esc_html_e('✖ Zuklappen', 'fabriel-team-manager'); ?></button>
            </div>
        </form>
        <?php
    }
    ...
    public static function renderPageOptions($selected_id, $pages_data) {
        $html = '<option value="0">— ' . esc_html__('Keine automatische Zuordnung', 'fabriel-team-manager') . ' —</option>';
        if (!empty($pages_data['with_block'])) {
            $html .= '<optgroup label="⭐ ' . esc_attr__('Seiten mit Team/Fussball Block', 'fabriel-team-manager') . '">';
        ...
        if (!empty($pages_data['without_block'])) {
            $html .= '<optgroup label="📄 ' . esc_attr__('Weitere Seiten', 'fabriel-team-manager') . '">';
