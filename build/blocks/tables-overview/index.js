 ...
 */
(()=>{"use strict";const e=window.wp.blocks,t=JSON.parse('{"UU":"fstm/fussball-tables-overview"}'),a=window.React,l=window.wp.i18n,n=window.wp.blockEditor,r=window.wp.components;(0,e.registerBlockType)(t.UU,{edit:function({attributes:e,setAttributes:t}){const{columns:i="2"}=e,o=window.fsTmDesign||{},s=o.previewStyle?o.previewStyle(e):{},m=o.SchemePanel,c=(0,n.useBlockProps)({style:{...s,borderRadius:"12px",overflow:"hidden",border:"1px solid rgba(0,0,0,0.12)",boxShadow:"0 4px 14px rgba(0,0,0,0.08)",cursor:"pointer"}});return(0,a.createElement)(a.Fragment,null,(0,a.createElement)(n.InspectorControls,null,(0,a.createElement)(r.PanelBody,{title:(0,l.__)("Layout Einstellungen","fabriel-team-manager"),initialOpen:!0},(0,a.createElement)(r.SelectControl,{label:(0,l.__)("Spalten:","fabriel-team-manager"),help:(0,l.__)("Anzahl der Spalten auf Desktop-Bildschirmen.","fabriel-team-manager"),value:i,options:[{label:"1 "+(0,l.__)("Spalte","fabriel-team-manager"),value:"1"},{label:"2 "+(0,l.__)("Spalten","fabriel-team-manager"),value:"2"},{label:"3 "+(0,l.__)("Spalten","fabriel-team-manager"),value:"3"}],onChange:e=>t({columns:e})})),m&&(0,a.createElement)(m,{attributes:e,setAttributes:t})),(0,a.createElement)("div",{...c},(0,a.createElement)("div",{style:{padding:"12px 18px",background:"var(--fs-tm-card-head-bg)",color:"var(--fs-tm-card-ink)",textAlign:"center",fontWeight:700,fontSize:"14px"}},(0,a.createElement)("span",{style:{marginRight:"6px"}},"🏆"),"Tabellen-Übersicht (Grid)"),(0,a.createElement)("div",{style:{padding:"18px 20px",background:"var(--fs-tm-card-body-bg)",color:"var(--fs-tm-body-ink)",textAlign:"center",fontSize:"13px"}},(0,a.createElement)("strong",{style:{display:"block",marginBottom:"4px"}},(0,l.__)("Raster-Ansicht","fabriel-team-manager")," (",i," ",(0,l.__)("Spalten","fabriel-team-manager"),")"),(0,a.createElement)("span",{style:{color:"var(--fs-tm-body-ink-soft)",fontSize:"12px"}},(0,l.__)("Zeigt alle aktiven Tabellen automatisch gruppiert an.","fabriel-team-manager")))))},save:()=>null})})();